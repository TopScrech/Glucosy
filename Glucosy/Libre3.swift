...
final class Libre3: Libre {
    ...
    var blePIN = Data()    // 4 bytes returned by the activation command
    ...
    class DPCRLInterface {
        ...
        static let ABT_ERR3_SENSOR_CAL_CODE_ = 0x170
        static let ABT_ERR3_SENSOR_DYNAMIC_DATA_CRC_ = 0x171
        static let ABT_ERR3_SENSOR_FACTORY_DATA_CRC_ = 0x172
        static let ABT_ERR3_SENSOR_LOG_DATA_CRC_ = 0x173
