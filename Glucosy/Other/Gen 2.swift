...
class Gen2 {
    ...
    static func createSecureSession(context: Int, _ i2: Int, data: Data) -> Int {
        p1(command: GEN2_CMD_GET_CREATE_SESSION, context, Data([UInt8(i2)]), data)
    }
    
    static func endSession(context: Int) -> Int {
        p1(command: GEN2_CMD_END_SESSION, context, nil, nil)
    }
    ...
    static func decryptStreamingData(context: Int, data: Data) -> Result {
        p2(command: GEN2_CMD_DECRYPT_BLE_DATA, p1: context, data, nil)
    }
}
