...
struct ChatAssistantResponse {
    @Guide(description: "A concise answer in the same language as the person's prompt. Make it clear that the carbohydrate values are estimates. Mention carbohydrates per 100 g or 100 ml, whichever fits the product better. Mention the carbohydrates for the chosen portion whenever you provide logCarbsAction")
